...
@interface ABChargeEditViewController ()<UITableViewDelegate, UITableViewDataSource, ABDatePickerDeleage, ABTextViewControllerDelegate, ABChargeEditDataManagerDelegate>
...
- (void)viewDidLoad
{
    ...
    _editDataManager.delegate = self;
